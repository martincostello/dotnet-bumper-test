...
function DotNetTest {
    ...
    & $dotnet test $Project --configuration "Release" --framework net6.0
...
function DotNetPublish {
    ...
    & $dotnet publish $Project --framework net6.0
...
$publishProjects = @(
    (Join-Path $solutionPath "src" "Application" "Application.csproj")
)

$testProjects = @(
    (Join-Path $solutionPath "tests" "Application.Tests" "Application.Tests.csproj")
)
